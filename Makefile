...
# github.com/fabiomnk/gitlab-operator/gitlab-operator-bundle:$VERSION and github.com/fabiomnk/gitlab-operator/gitlab-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= github.com/fabiomnk/gitlab-operator/gitlab-operator
